const HeroSection = () => {
  return (
    <section className="relative h-[60vh] bg-gradient-to-br from-blue-900 via-black to-purple-900 flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6">
        <h1 className="text-5xl md:text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 drop-shadow-lg mb-6">
          Welcome to the EduCore
        </h1>
        <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
          Transforming Education with Innovative Solutions. Empowering
          Institutions, Enabling Students, and Shaping the Leaders of Tomorrow.
        </p>
